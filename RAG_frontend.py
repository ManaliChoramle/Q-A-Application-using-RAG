...
st.set_page_config(page_title="Employee HR Q & A with RAG") ### Modify Heading

new_title = '<p style="font-family:sans-serif; color:Green; font-size: 42px;"> Employee HR Q & A with RAG 🎯</p>'
...
go_button = st.button("📌GenAI with Manali Choramle", type="primary") ### Button Name
